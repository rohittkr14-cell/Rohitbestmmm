...
async def cmd_lock(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        await context.bot.send_message(chat_id=chat_id, text=f"❌ Lock failed. Make sure bot is admin with 'restrict members' permission. Error: {e}")
...
async def cmd_unlock(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        await context.bot.send_message(chat_id=chat_id, text=f"❌ Unlock failed. Make sure bot is admin with 'restrict members' permission. Error: {e}")
...
async def cmd_ban(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        await context.bot.send_message(chat_id=chat_id, text=f"❌ Ban failed. Make sure bot is admin. Error: {e}")
...
async def cmd_unban(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        await context.bot.send_message(chat_id=chat_id, text=f"❌ Unban failed. Error: {e}")
...
async def cmd_kick(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        await context.bot.send_message(chat_id=chat_id, text=f"❌ Kick failed. Make sure bot is admin. Error: {e}")
...
async def cmd_mute(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        await context.bot.send_message(chat_id=chat_id, text=f"❌ Mute failed. Make sure bot is admin. Error: {e}")
...
async def cmd_unmute(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        await context.bot.send_message(chat_id=chat_id, text=f"❌ Unmute failed. Make sure bot is admin. Error: {e}")
...
async def handle_group_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if args:
        ...
        context.args = []
    handler_map = {
        'set': cmd_set, 'rec': cmd_rec, 'agree': cmd_agree, 'confirm': cmd_confirm,
        'inr': cmd_inr, 'crp': cmd_crp, 'link': cmd_link, 'done': cmd_done,
        'lock': cmd_lock, 'unlock': cmd_unlock, 'kick': cmd_kick, 'ban': cmd_ban,
        'unban': cmd_unban, 'mute': cmd_mute, 'unmute': cmd_unmute,
        'id': cmd_id, 'help': cmd_help, 'close': cmd_close, 'start': cmd_start,
        'setinrphoto': cmd_setinrphoto, 'editcrp': cmd_editcrp,
        'setvouch': cmd_setvouch, 'cancel': cmd_cancel,
    }
...
def run_fake_server():
    ...
    logger.info(f"🌐 Fake HTTP server running on port {port} (for Render health check)")
...
def main():
    ...
    # Start fake HTTP server in a separate thread
    ...
    logger.info("🤖 Bot started with fake HTTP server...")
